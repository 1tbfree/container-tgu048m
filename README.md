...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-tgu048m.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-tgu048m.containers.anotherwebservice.com/
...
```
git clone git@github.com:1tbfree/container-tgu048m.git
cd container-tgu048m
```
...
```
docker attach container-tgu048m
```
